...
<script src="<s:url value="/AdminPages/assets/vendors/base/vendors.bundle.js" />" type="text/javascript"></script>
<script src="<s:url value="/AdminPages/assets/demo/default/base/scripts.bundle.js" />" type="text/javascript"></script>
<!--end::Base Scripts -->


<!--begin::Page Vendors -->
<script src="<s:url value="/AdminPages/assets/vendors/custom/jquery-ui/jquery-ui.bundle.js" />" type="text/javascript"></script>
<script src="<s:url value="/AdminPages/assets/vendors/custom/fullcalendar/fullcalendar.bundle.js" />" type="text/javascript"></script>
<!--end::Page Vendors -->
...
<!--begin::Page Snippets -->
<script src="<s:url value="/AdminPages/assets/app/js/dashboard.js" />" type="text/javascript"></script>
<!--end::Page Snippets -->
