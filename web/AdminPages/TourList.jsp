                        ...
                        <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                    <a target="_blank" href="/administrator/create-new-tour" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                        <span>
...
//                            template: '{{OrderID}} - {{ShipCountry}}'
                            ...
                            template: function(row) {
                                return row.adultPrice.toFixed(2)
                            },
                        }, {
                            field: "childPrice",
                            title: "Child Price",
                            ...
                            template: function (row, index, datatable) {
                                ...
                                return '\
						<a target="_blank" href="'+contextPath+'/administrator/edit-tour/'+row.titleUrl+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">\
							<i class="la la-edit"></i>\
						</a>\
						<a data-value='+row.id+' class="btn-delete-tour m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">\
            ...
            $('body').on('click', '.btn-delete-tour', function(e){
                var id = $(this).attr('data-value');
                $(this).closest('tr').addClass('to-delete');
                $.ajax({
                    url: '<s:url value="/administrator/DeleteTourAction" />',
                    method: 'POST',
                    dataType: "json",
